        ...
        <tr>
            ...
            <td>
                ...
                <p>
                    ...
                    <?php
                    _e(
                        'This will add Javascript to your website which will listen to changes to the price inside the given container.',
                        'autive-lbb'
                    )
                    ?>
                    <br>
                    <?php
                    _e(
                        'When the price changes the button will be updated with the correct price, amount and url.',
                        'autive-lbb'
                    )
                    ?>
                    <br>
